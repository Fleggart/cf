...
import tk.zeitheron.botanicadds.flowers.LightningFlower;
import tk.zeitheron.botanicadds.flowers.RainFlower;
import tk.zeitheron.botanicadds.flowers.SnowFlower;
import tk.zeitheron.botanicadds.flowers.WitherFlower;
...
{
    public static final List<Class<? extends SubTileEntity>> flowers = new ArrayList<>();
    ...
    {
        // 手动添加所有花
        flowers.add(WitherFlower.class);
        flowers.add(RainFlower.class);
        flowers.add(SnowFlower.class);
        flowers.add(LightningFlower.class);
        LOG.info("Registered {} flowers", flowers.size());
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> e)
    {
        ...
        LOG.info("Registered {} flower blocks", flowers.size());
    }
